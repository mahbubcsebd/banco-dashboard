...
const PaymentViewModal = ({ isOpen, onClose, paymentData }) => {
  ...
  const totalFees = data.id % 2 === 0 ? 2.3 : 1.5;

  const handlePrint = () => {
    console.log(
      'Printing confirmation for:',
        ...
        <div className="p-6 space-y-4">
          ...
          <div className="space-y-3 text-sm">
            ...
            <div className="flex justify-between pb-1">
              ...
              <span className="text-gray-900 font-semibold">
                {data.confirmationNumber || '8523341'}
              </span>
            </div>
            ...
            <div className="flex justify-between pb-1">
              ...
              <span className="text-gray-900 font-semibold">
                {data.payFrom || 'Savings 210001002331'}
              </span>
            </div>
            ...
            <div className="flex justify-between pb-1">
              ...
              <span className="text-gray-900 font-semibold">HSBC Corp</span>
            </div>
            ...
            <div className="flex justify-between pt-2 border-t border-gray-200">
              ...
              <span className="text-gray-900 font-semibold">
                {data.currency || 'USD'}{' '}
                {data.amount ? data.amount.toFixed(2) : '10.00'}
              </span>
            </div>
            ...
            <div className="flex justify-between">
              ...
              <span className="text-gray-900 font-semibold">
                {data.date ? data.date.split(' ')[0] : '2025-11-04'} 02:55:07
              </span>
            </div>
          ...
          <div className="pt-4 space-y-4">
            <Button
              ...
              onClick={onClose}
              size="default"
              className="w-full py-3 bg-orange-500 hover:bg-orange-600 text-white font-semibold text-base shadow-md"
            >
              Done
            </Button>
