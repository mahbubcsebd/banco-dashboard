  ...
  return (
    ...
    >
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        {/* Row 3: Scheduling Fields (Dynamic) */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-start">
          {/* Left Side: Transfer Type & Start Date */}
          <div className="space-y-4">
            ...
            {/* Start Date Input (Only when Scheduled is ON) */}
            {isScheduled && (
              <motion.div
          ...
          <GlobalInput
            ...
            isTextarea
            rows={isScheduled ? 5 : 3}
            value={formData.description}
            onChange={(e) => handleChange('description', e.target.value)}
            error={errors.description}
          />
        </div>
        {/* Conditional Recurring Fields (How Often & Until) - Full Width */}
        {isScheduled && (
          <motion.div
            initial={{ opacity: 0, height: 0 }}
            animate={{ opacity: 1, height: 'auto' }}
          ...
          >
            ...
            <div className="flex flex-wrap gap-4">
              ...
              {errors.howOften && (
                <p className="text-sm text-red-500 mt-1">{errors.howOften}</p>
              )}
            </div>
