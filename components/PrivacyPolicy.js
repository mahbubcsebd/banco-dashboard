...
import { Chrome, Mail, Monitor, Phone, Smartphone } from 'lucide-react';
import Link from 'next/link';

const PrivacyPolicy = () => {
  return (
    <div className="py-12 sm:py-16 md:py-20 px-4 bg-gradient-to-br from-orange-50 via-white to-orange-50">
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-sm sm:text-base md:text-lg text-gray-600 max-w-2xl mx-auto">
            Learn about our privacy practices and system requirements
          </p>
        </motion.div>
      </div>
        ...
        <div className="prose prose-gray max-w-none">
          ...
          <section className="mb-8">
            ...
            <div className="mb-6">
              ...
              <ul className="space-y-2 text-gray-700 list-disc list-inside ml-8">
                <li>Microsoft Edge v38, 40, 41 (on Windows 10)</li>
                <li>Chrome v66, 67, 68 on Windows</li>
                <li>Firefox v59, 60, 61 on Windows</li>
                <li>Safari 10.0, 10.1, 11.0 on Mac</li>
              </ul>
            </div>
            ...
            <div className="mb-6">
              ...
              <ul className="space-y-2 text-gray-700 list-disc list-inside ml-8">
                <li>
                  Chrome browser on Android 9.0 and above, tablets and
                  smartphones
                </li>
                <li>Safari on iOS 15, 16 and 17 tablets and smartphones</li>
                <li>Microsoft Edge on Windows 10 Mobile</li>
              </ul>
            </div>
            ...
            <div className="mb-6">
              ...
              <p className="text-gray-700 leading-relaxed ml-8">
                All operating systems with the supported web browsers
              </p>
            </div>
            ...
            <div className="bg-gradient-to-r from-orange-50 to-blue-50 border border-orange-200 rounded-lg p-6">
              <h3 className="text-xl font-semibold text-gray-900 mb-4">
                Mobile OS Version Compatibility
              </h3>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="bg-white rounded-lg p-4 border border-gray-200">
                  <p className="font-semibold text-gray-900 mb-2">Android</p>
                  <p className="text-gray-700">Android 9.0 and above</p>
                </div>
                <div className="bg-white rounded-lg p-4 border border-gray-200">
                  <p className="font-semibold text-gray-900 mb-2">iOS</p>
