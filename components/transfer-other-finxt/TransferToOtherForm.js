...
const TransferToOtherForm = ({ onSubmit, isSubmitting = false }) => {
  ...
  // --- State and Handlers (Logic remains correct) ---
  ...
  return (
    <motion.div
      ...
      // Centralized container consistent with previous forms
    ...
    >
      <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="space-y-4">
            ...
            {isScheduled && (
              ...
              >
                ...
                {/* Conditional Until Fields (Only for recurring, i.e., howOften !== 'once') */}
                {isRecurring && (
                  <motion.div
                    initial={{ opacity: 0, height: 0 }}
                    animate={{ opacity: 1, height: 'auto' }}
        ...
        {/* Buttons (Cancel/Submit) - Aligned to the right (end) of the container */}
